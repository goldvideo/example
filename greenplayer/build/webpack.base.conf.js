...
module.exports = {
  ...
  output: {
    ...
    // filename: 'greenplayer-h265.js', // string
    // the filename template for entry chunks

    library: 'GreenPlayer', // string,
    ...
    rules: [
      {
        ...
        // exclude: /(node_modules((\/@goldvideo\/lego\-goldplay)$)|bower_components)/,
        // exclude: /(node_modules(?!(\/@goldvideo\/lego\-goldplay)$)|bower_components)/,
        include: [
          path.join(__dirname, '../../../h265player/src/'),
          path.join(__dirname, '../node_modules/@goldvideo/h265player'),
  ...
  plugins: [
    ...
    new webpack.BannerPlugin('GreenPlay built @' + new Date().toLocaleString()),
    // new CopyPlugin([
    //   {
